...
## Features
- **Photo Memories**: Securely save daily photos to your private storage to capture visual memories alongside your text.
...
- **Daily Fortune Cookie**: Crack open a daily motivational quote (100+ offline quotes) to start your day right.
...
1. Clone the repository: `git clone https://github.com/Synthetic-Sage/Self-Sight.git`
