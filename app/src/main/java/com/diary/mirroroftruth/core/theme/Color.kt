...
val AccentTeal = Color(0xFF4A8B8C) // Soft teal
val AccentGold = Color(0xFFD4AF37) // Fortune cookie / streak color
val NotebookLine = Color(0xFF9CA3AF).copy(alpha = 0.3f) // Faint lines
